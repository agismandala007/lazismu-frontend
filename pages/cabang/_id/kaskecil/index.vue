  ...
  >
    ...
    <section class="pt-[50px]">
      ...
      <div class="md:container md:mx-auto">
          ...
          >
            ...
            <tbody>
              ...
              <tr
                ...
                v-else
                v-for="(item, index) in kaskecil.data.result.data"
                :key="index"
              >
                <th scope="row" class="py-4 px-6 font-medium text-gray-900">
                  {{ kaskecil.data.result.current_page * 10 - 10 + index + 1 }}
                </th>
        ...
        <p v-else-if="$fetchState.error">An error occurred :(</p>
        <nav
          v-else-if="kaskecil.data.result.links"
        ...
        >
          <span class="text-sm font-normal text-gray-500"
            ...
            <span class="font-semibold text-gray-900">{{
              kaskecil.data.result.last_page
            }}</span></span
          >
          <ul class="inline-flex items-center -space-x-px">
            <li>
              <button
                :value="kaskecil.data.result.current_page - 1"
                @click="updatePage"
                ...
                :disabled="kaskecil.data.result.current_page == 1"
              >
                <
              </button>
            </li>
            ...
            <li
              v-else
              v-for="(ada, index) in kaskecil.data.result.links"
              :key="index"
            >
              <button
                v-if="
            ...
            <li>
              <button
                ...
                :disabled="pagenow == kaskecil.data.result.last_page"
              >
                >
              </button>
            </li>
