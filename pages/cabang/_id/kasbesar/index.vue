  ...
  >
    ...
    <section class="pt-[100px]">
      ...
      <div class="md:container md:mx-auto">
          ...
          <table class="w-full text-sm text-left text-gray-500">
            ...
            >
              <div class="bg-white flex justify-between items-center">
                ...
                <NuxtLink
                  :to="{
                    name: 'cabang-id-kasbesar-create',
                    params: { id: cabang_id },
                  }"
            ...
            <tbody>
              ...
              <tr
                ...
                v-else
                v-for="(item, index) in kasbesar.data.result.data"
                :key="index"
              >
        ...
        <p v-else-if="$fetchState.error">An error occurred :(</p>
        <nav
          v-else-if="kasbesar.data.result.links"
        ...
        >
          <span class="text-sm font-normal text-gray-500"
            ...
            <span class="font-semibold text-gray-900">{{
              kasbesar.data.result.last_page
            }}</span></span
          >
          <ul class="inline-flex items-center -space-x-px">
            ...
            <li
              v-else
              v-for="(ada, index) in kasbesar.data.result.links"
              :key="index"
            >
              <button
                v-if="
