  ...
  <div class="lg:pr-[70px] py-[50px] lg:ml-[320px] xl:ml-[365px] px-4 lg:pl-0">
    ...
    <section class="pt-[50px]">
      ...
      <div class="md:container md:mx-auto">
          ...
          >
            ...
            >
              <tr>
                ...
                <th scope="col" class="py-3 px-6">No Bukti</th>
            ...
            <tbody>
              ...
              <tr
                ...
                v-else v-for="(item, index) in jurnalumum.data.result.data" :key="index"
              >
        ...
        <p v-if="$fetchState.pending">Fetching roles...</p>
        <p v-else-if="$fetchState.error">An error occurred :(</p>
        <nav v-else-if="jurnalumum.data.result.links"
          ...
          >
            <span class="text-sm font-normal text-gray-500"
              ...
              of
              <span class="font-semibold text-gray-900"
                >{{ jurnalumum.data.result.last_page }}</span
              ></span
            >
            <ul class="inline-flex items-center -space-x-px">
              ...
              <p v-if="$fetchState.pending">Fetching roles...</p>
              <p v-else-if="$fetchState.error">An error occurred :(</p>
              <li v-else v-for="(ada, index) in jurnalumum.data.result.links" :key="index">
...
export default {
  ...
  methods: {
    ...
    fetch1() {
      ...
      }).then(response => this.jurnalumum = response.result.data)
      .catch(error => {});
      this.$nuxt.refresh()
    }
  },
